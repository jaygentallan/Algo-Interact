...
export default class GraphVisualizer extends React.Component {
    ...
    */
	...
	linearSearch = () => {
		if (this.state.algoData.keyNode !== undefined && this.state.algoData.keyNode !== "") {
			var counter = 0;
			...
			<div class="box">
				<div className="pt-3">
					<div className="listInfo">
						<h5 className="font-weight-light" style={head}>{`Head: ${this.state.headName}`}</h5>
						<h5 className="font-weight-light pt-1" style={tail}>{`Tail: ${this.state.tailName}`}</h5>
					</div>
				</div>
