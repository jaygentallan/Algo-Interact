		...
		<div class="row pt-3">
			...
			<Modal show={isOpen} onHide={hideModal} size="lg">
				...
				<Modal.Body>
					...
					<p>
						<strong>Graph Settings</strong>: Alter the color and size of all the nodes or links in the graph.
					</p>
					<p>
					...
					{props.rButtons ? <h2 className="helpModal2">{props.rButtons}</h2> : <div></div>}
					<p>
